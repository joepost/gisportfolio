...
Figures *a–c* are visualisations of the input datasets used in the population disaggregation model: the WorldPop gridded population count, GHSL Settlement Model Grid (GHS-SMOD), and DynamicWorld-derived cropland cover, respetively. Figure *d* shows the output of the model. 
...
As an analyst in the Spatial Analysis Unit at AIHW, I worked on the early stages of development for Regional Insights, in Esri ArcGIS. Below is a screenshot from the Indigenous communities interactive map. To explore the website, see [here](https://www.rific.gov.au/regional-overview/interactive-map).
